<x-jet-action-section>
    ...
    <x-slot name="description">
        Configura y cierra tus sesiones activas en ontros navegadores o dispositivos.
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            Si es necesario, podrías cerrar sesión en todos los navegadores o dispositivos.
            Algunas de tus más recientes sesiones están listadas debajo; De cualquie manera,
            esta lista no debe ser exhaustiva. Si sientes que tu cuenta podría estar comprometida,
            deberías también cambiar tu contraseña.
        </div>
        ...
        <div class="flex items-center mt-5">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled">
                Cierra sesión en otros navegadores
            </x-jet-button>
