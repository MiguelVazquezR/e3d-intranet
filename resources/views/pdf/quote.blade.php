    ...
    <div class="text-xs">
        ...
        <div>
            ...
            <p class="w-11/12 mx-auto my-2 pb-2 text-gray-700">
                Por medio de la presente reciba un cordial saludo y a su vez le proporciono la cotización que nos solicitó,
        ...
        <table class="rounded-t-lg m-2 w-11/12 mx-auto bg-gray-300 text-gray-800" style="font-size: 10.2px;">
            ...
            <tbody>
                ...
                <tr class="bg-gray-200 text-gray-700">
                    ...
                    <td class="px-2 py-px">{{ number_format($q_product->price, 2) . ' ' . $quote->currency->name }}</td>
        ...
        <div class="w-11/12 mx-auto my-3 grid grid-cols-5 gap-4 ">
            ...
            <div class="bg-gray-200 rounded-t-xl rounded-b-md border" style="font-size: 8px;">
                <img class="rounded-t-xl max-h-52 mx-auto" src="{{ Storage::url($q_product->product->image) }}">
            ...
            <div class="bg-gray-200 rounded-t-xl rounded-b-md" style="font-size: 8px;">
                <img class="rounded-t-xl max-h-52 mx-auto" src="{{ Storage::url($q_product->compositProduct->image) }}">
        ...
        <p class="w-11/12 mx-auto my-2 pb-2 text-gray-700">
            ...
            Folio de cotización: <span class="font-bold bg-yellow-100">COT-{{ str_pad($quote->id, 4, '0', STR_PAD_LEFT) }}</span>
        </p>

        <!-- Notes -->
        <div class="w-11/12 mx-auto border border-gray-500 px-3 pb-1 mt-1 rounded-xl text-gray-500 leading-normal uppercase" style="font-size: 10.5px;">
            <h2 class="text-center font-extrabold">IMPORTANTE <i class="fas fa-exclamation-circle text-amber-500"></i></h2>
            <ol class="list-decimal mx-2 mb-2">
                ...
                @endif
                <li>TIEMPO DE ENTREGA PARA LA PRIMER PRODUCCIÓN <span class="font-bold text-blue-500">{{ $quote->first_production_days }}</span>.
                    EL TIEMPO CORRE UNA VEZ PAGANDO EL 100% DEL HERRAMENTAL Y EL 50% DE LOS PRODUCTOS.</li>
                <li>FLETES Y ACARREOS CORREN POR CUENTA DEL CLIENTE: <span class="font-bold text-blue-500">{{ $quote->freight_cost }}</span></li>
                <li>PRECIOS EN <span class="font-bold text-blue-500">{{ $quote->currency->name }}</span></li>
                <li>COTIZACIÓN VÁLIDA POR 21 DÍAS. EL PRODUCTO ESTÁ SUJETO A LA REVISIÓN DEL DISEÑO FINAL, PRUEBAS Y SUBSECUENTE APROBACIÓN</li>
            </ol>
            PAGOS.- POR TRANSFERENCIA BANCARIA O DEPÓSITO ENVIARSE A MARIBEL@EMBLEMAS3D.COM O ASISTENTE.DIRECTOR@EMBLEMAS3D.COM <br>
        ...
        <footer class="text-gray-400 w-11/12 mx-auto mt-3" style="font-size: 11px;">
            <div class="grid grid-cols-3 gap-x-4">
                ...
                <div>
                    <i class="fas fa-globe"></i> www.emblemas<b class="text-sky-600">3</b><b class="text-red-600">d</b>.com <br>
