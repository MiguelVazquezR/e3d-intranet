<div>
    <div class="rounded-md w-11/12 mx-auto">
        <div>
                    ...
                    <table class="min-w-full leading-normal">
                        <thead>
                            <tr>
                                ...
                                <th wire:click="order( '{{$key}}' )" class="cursor-pointer px-3 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 tracking-wider">
                                ...
                                @endforeach
                                <th class="w-28 px-px py-3 border-b-2 border-gray-200 bg-gray-100 text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                    &nbsp;
                                </th>
                                <th class="py-3 border-b-2 border-gray-200 bg-gray-100 text-xs font-semibold text-gray-600 uppercase tracking-wider">
                                    &nbsp;
                                </th>
                            </tr>
                        </thead>
