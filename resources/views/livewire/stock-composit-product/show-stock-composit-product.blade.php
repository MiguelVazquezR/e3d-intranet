        ...
        <x-slot name="title">
            ...
            <ul class="flex justify-center items-center pb-4" x-data="{
                ...
                <template x-for="(tab, index) in tabs" :key="index">
                    <li class="cursor-pointer text-sm py-2 px-6 text-gray-500 border-b-2" :class="activeTab===index ? 'text-black border-black' : ''" @click="activeTab = index; changeAction(); $dispatch('change-tab-cp-show', index);" x-text="tab"></li>
                </template>
            </ul>
            <!--tab component end-->
