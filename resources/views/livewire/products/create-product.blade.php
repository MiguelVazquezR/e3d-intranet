        ...
        <x-slot name="content">
            ...
            <div class="grid grid-cols-5 gap-4">
                ...
                <div class="col-span-3">
                    ...
                    <x-select class="mt-2 w-1/2 lg:w-3/4" wire:model.defer="measurement_unit_id" :options="$units" />
            ...
            <div class="mb-4">
                ...
                <x-select class="w-3/4 mt-2" wire:model.defer="product_material_id" :options="$materials" />
                <x-jet-secondary-button class="ml-2 rounded-full"
