        ...
        <x-slot name="content">
            ...
            <div class="lg:grid lg:grid-cols-2 lg:gap-2">
                <div>
                    ...
                    <x-jet-input wire:model.defer="purchase_order.shipping_company" type="text" class="w-full mt-2 input" />
                    <x-jet-input-error for="purchase_order.shipping_company" class="text-xs" />
                </div>
                <div>
                    <x-jet-label value="Guía" class="mt-3 dark:text-gray-400" />
                    <x-jet-input wire:model.defer="purchase_order.tracking_guide" type="text" class="w-full mt-2 input" />
