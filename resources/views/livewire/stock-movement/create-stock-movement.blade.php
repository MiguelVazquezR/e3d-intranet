    ...
    <x-jet-dialog-modal wire:model="open">
        ...
        <x-slot name="content">
            <div class="mb-4">
                ...
                <x-select class="w-3/4 mt-2" wire:model.defer="stock_action_type_id" :options="$stock_action_types" />
                <x-jet-secondary-button class="ml-2 rounded-full"
                    wire:click="$emitTo('stock-action-type.create-stock-action-type', 'openModal', 'entradas')">
                    <i class="fas fa-plus"></i>
                </x-jet-secondary-button>
                <x-jet-input-error for="stock_action_type_id" class="text-xs" />
            </div>
