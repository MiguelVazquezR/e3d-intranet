    ...
    <x-jet-dialog-modal wire:model="open">
        ...
        <x-slot name="content">
            ...
            <div>
                ...
                <x-jet-input-error for="first_production_days" class="mt-3" />
            </div>
            ...
            <div class="grid grid-cols-3 gap-4">
                <div>
                    ...
                    <x-jet-input-error for="tooling_cost" class="mt-3" />
                </div>
                ...
                <div class="flex items-start mt-6">
                    <div class="flex items-center h-5">
                        <input id="strikethrough" wire:click="toggleStrikeThrough" wire:model="strikethrough_tooling_cost" type="checkbox" class="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-blue-300 h-4 w-4 rounded">
                    </div>
                    <div class="text-sm ml-3">
                        <label for="strikethrough" class="font-medium text-gray-800">Tachar costo</label>
                        @if($strikethrough_tooling_cost)
                        <div class="text-gray-500">
                            <span class="font-normal text-xs line-through">{{ $tooling_cost }} {{ $tooling_currency }}</span>
                        </div>
                        @else
                        <div class="text-gray-500">
                ...
                <div class="col-span-2">
                    ...
                    <x-jet-input-error for="freight_cost" class="mt-3" />
                </div>
            ...
            <x-select class="mt-2 w-1/2" wire:model.defer="currency_id">
            ...
            <x-jet-input-error for="currency_id" class="mt-3" />
                ...
                <div class="col-span-2">
                    <div class="flex justify-between">
                        ...
                        <div>
                            ...
                            @else
                            <i wire:click="editProductFromList" class="fas fa-check-circle text-green-600 hover:cursor-pointer"></i>
                            @endif
            ...
            <x-item-list :index="$i" :active="true" :objectId="null">
                <x-product-quick-view :image="$current_product->image" :name="$current_product instanceof App\Models\Product ? $current_product->name : $current_product->alias">
                    ...
                    @endif
                    <span class="text-blue-500">{{ $product["price"] . App\Models\Currency::findOrFail($currency_id)->name }}</span>&nbsp; por unidad
                </x-product-quick-view>
            </x-item-list>
            @endforeach
            <div>
                <x-jet-label value="Notas" class="mt-3" />
                <textarea wire:model.defer="notes" rows="5" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm w-full"></textarea>
