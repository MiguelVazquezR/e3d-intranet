        ...
        <x-slot name="content">
            <div class="lg:grid lg:grid-cols-2 lg:gap-3">
                <div>
                    ...
                    <x-jet-input wire:model="name" type="text" class="w-full mt-2" />
                    <x-jet-input-error for="name" class="mt-3" />
                </div>
                <div>
                    <x-jet-label value="Correo" class="mt-3" />
                    <x-jet-input wire:model.defer="email" type="text" class="w-full mt-2" />
                ...
                <div>
                    ...
                    <x-select class="mt-2 w-full" wire:model.defer="department_id">
                    ...
                    <x-jet-input-error for="department_id" class="mt-3" />
                </div>
                <div>
                    <x-jet-label value="Puesto" class="mt-3" />
                    <x-jet-input wire:model.defer="job_position" type="text" class="w-full mt-2" />
                    <x-jet-input-error for="job_position" class="mt-3" />
                </div>
                <div>
                    <x-jet-label value="Salario por hora" class="mt-3" />
                    <x-jet-input wire:model.defer="salary" type="number" class="w-full mt-2" />
                    <x-jet-input-error for="salary" class="mt-3" />
                </div>
                <div>
                    <x-jet-label value="Retenciones" class="mt-3" />
                    <x-jet-input wire:model.defer="discounts" type="number" class="w-full mt-2" />
                    <x-jet-input-error for="discounts" class="mt-3" />
                </div>
                <div>
                    <x-jet-label value="Horas semanales" class="mt-3" />
                    <x-jet-input wire:model.defer="hours_per_week" type="number" class="w-full mt-2" />
                    <x-jet-input-error for="hours_per_week" class="mt-3" />
                </div>
                <div>
