        ...
        <x-slot name="content">
            <div class="lg:grid lg:grid-cols-4 lg:gap-x-2">
                ...
                <div class="lg:col-span-3">
                    ...
                    <x-jet-input wire:model.defer="address" type="text" class="w-full mt-2 placeholder:text-xs input"
            ...
            @if ($add_bank_data || !is_null($edit_bank_data_index))
                <div class="p-3 bg-sky-200 dark:bg-sky-300 my-1 rounded-2xl">
                    ...
                    <div class="lg:grid lg:grid-cols-2 lg:gap-x-2">
                        <div>
                            <x-jet-label value="Nombre de beneficiario" class="mt-3 dark:text-gray-500" />
                        ...
                        <div>
                            <x-jet-label value="Número de cuenta" class="mt-3 dark:text-gray-500" />
            ...
            @if ($add_contact || !is_null($edit_contact_index))
                <div class="p-3 bg-sky-200 dark:bg-sky-300 my-1 rounded-2xl">
                    ...
                    <div>
                        <x-jet-label value="Nombre" class="mt-1 dark:text-gray-500" />
                    ...
                    <div class="lg:grid lg:grid-cols-2 lg:gap-x-2">
                        <div>
                            <x-jet-label value="Correo" class="mt-3 dark:text-gray-500" />
                        ...
                        <div>
                            <x-jet-label value="Teléfono" class="mt-3 dark:text-gray-500" />
                            <x-jet-input wire:model.defer="contact_phone" type="text" class="w-full mt-2 input" />
                            <x-jet-input-error for="contact_phone" class="text-xs" />
                        </div>
                        <div class="col-span-full">
                            <x-jet-label value="Fecha de nacimiento" class="mt-3 dark:text-gray-500" />
                            <div class="grid grid-cols-2 gap-3">
                                <div>
                                    <x-jet-label value="Día" class="mt-3 dark:text-gray-500" />
                                ...
                                <div>
                                    <x-jet-label value="Mes" class="mt-3 dark:text-gray-500" />
