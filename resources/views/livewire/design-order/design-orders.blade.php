            ...
            <x-slot name="body">
                ...
                <tr>
                    ...
                    <td class="w-28 px-px py-3 border-b border-gray-200 bg-white">
                        ...
                        <i wire:click="$emit('confirm', {0:'design-order.design-orders', 1:'delete' ,2:{{$item->id}}, 3:'Este proceso no se puede revertir'})" class="fas fa-trash bg-red-500 text-white p-2 rounded-lg ml-1 hover:cursor-pointer"></i>
                        @endcan
                    </td>
