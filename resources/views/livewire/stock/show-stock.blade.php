                            ...
                            @if ($stock_product->product)
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <p>{{ $stock_product->quantity . ' ' . $stock_product->product->unit['name'] }}
                                        </p>
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <tbody>
                                        @foreach ($stock_movements as $movement)
                                            <tr class="text-xs my-2 bg-green-100 border-b border-green-300">
                                                ...
                                                <td class="w-1/5 p-1">
                                                    {{ $movement->quantity . ' ' . $movement->stockProduct->product->unit->name }}
                                                </td>
                                                <td class="w-1/5">
                    ...
                    @foreach ($stock_movements as $movement)
                        <tr class="text-xs my-2 bg-red-100 border-b border-red-300">
                            ...
                            <td class="w-1/5 p-1 flex justify-between">
                                {{ $movement->quantity . ' ' . $movement->stockProduct->product->unit->name }} </td>
                            <td class="w-1/5">
                                @if ($movement->notes)
                                    {{ $movement->notes }}
                                @else
