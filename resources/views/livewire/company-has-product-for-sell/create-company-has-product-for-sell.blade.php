        ...
        <x-slot name="content">
            ...
            <div class="lg:grid lg:grid-cols-3 lg:gap-2 mb-3">
                <div>
                    ...
                    <x-jet-input-error for="old_price" class="mt-3" />
                </div>
                <div>
                    <x-jet-label value="Moneda" class="mt-3" />
                    <x-select class="mt-2 w-full" wire:model.defer="old_price_currency">
                ...
                <div>
                    ...
                    <x-jet-input-error for="old_date" class="mt-3" />
                </div>
                <div>
                ...
                <div>
                    ...
                    <x-jet-input-error for="new_date" class="mt-3" />
                </div>
            </div>

            @if( is_null($edit_index) )
            <div wire:click="addItemToList" class="mb-2 hover:cursor-pointer flex justify-end items-center text-green-600 mt-3">
            ...
            @endphp
            <x-item-list :index="$i" :active="true">
